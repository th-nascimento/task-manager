...
const initialRows = [
  createData(1, 'Fazer Atividade Pratica', 'Ativ P do curso de Práticas Integradoras', '2024-05-15', '2024-02-06', 'Concluída', 'Recurso 1'),
  createData(2, 'Fazer Lista de Revisão', 'Revisar conteudos de SQL', '2024-05-15', '2024-02-06', 'Em Andamento', 'Recurso 2'),
];
